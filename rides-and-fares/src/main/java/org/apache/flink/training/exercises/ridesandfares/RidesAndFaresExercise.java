...
public class RidesAndFaresExercise {
  ...
  public static class EnrichmentFunction
    ...
    public void open(Configuration config) throws Exception {
      ValueStateDescriptor<TaxiRide> rideDescriptor = new ValueStateDescriptor<>("rideState",
          TypeInformation.of(new TypeHint<TaxiRide>() {
          }));
      ValueStateDescriptor<TaxiFare> fareDescriptor = new ValueStateDescriptor<>("fareState",
